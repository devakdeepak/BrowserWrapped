...
class _ActivityPageState extends State<ActivityPage>
  ...
  Future<void> _loadStats() async {
    try {
      ...
      if (!mounted) return;
      setState(() {
        browsingDays = data['active_days'] as int;
        longestStreak = data['longest_streak_days'] as int;
        _isLoading = false;
      });
  ...
  Widget _buildHeader() {
    return const Column(
      ...
      children: [
        ...
        SizedBox(height: 8),
        Text(
          'How consistently you kept coming back.',
          style: TextStyle(
            color: kSilver,
            fontSize: 15,
          ),
  ...
  Widget _buildBody() {
    ...
    if (_loadError != null) {
      return Container(
        ...
        child: Text(
          'Could not load activity: $_loadError',
    ...
    return Column(
      children: [
        _buildAnimatedStat(
          ...
          title: 'Days With Browsing Activity',
          value: browsingDays.toString(),
        ),
        _buildAnimatedStat(
          index: 1,
    ...
    return Row(
      ...
      children: [
        _buildPillButton(
          ...
          foreground: kWhite,
          // UniquePage is already underneath this page on the
          // navigation stack, so pop returns to it directly rather
          // than pushing a second copy.
